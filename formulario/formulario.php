...
<form action="#" method="post">
    <div class="form-row">
        ...
        <div class="form-group col-md-3">
            ...
            <input class="form-control <?= $erros["nascimento"] ? "is-invalid" : "" ?>" type="text" name="nascimento" id="nascimento" placeholder="Nascimento" value="<?= $_POST["nascimento"] ?>">
            <div class="invalid-feedback">
                <?= $erros["nascimento"] ?>
            </div>
        </div>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input class="form-control <?= $erros["site"] ? "is-invalid" : "" ?>" type="text" name="site" id="site" placeholder="Site" value="<?= $_POST["site"] ?>">
            <div class="invalid-feedback">
                <?= $erros["site"] ?>
            </div>
        </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input class="form-control <?= $erros["filhos"] ? "is-invalid" : "" ?>" type="number" name="filhos" 
            id="filhos" placeholder="Qtde de Filhos" value="<?= $_POST["filhos"] ?>"
            min="0" max="20">
            <div class="invalid-feedback">
                <?= $erros["filhos"] ?>
            </div>
        ...
        <div class="form-group col-md-6">
            ...
            <input class="form-control <?= $erros["salario"] ? "is-invalid" : "" ?>" type="text" name="salario" id="salario" placeholder="Salário" value="<?= $_POST["salario"] ?>">
            <div class="invalid-feedback">
                <?= $erros["salario"] ?>
            </div>
        </div>
